...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-06-2021 a las 17:15:42
...
--
CREATE DATABASE IF NOT EXISTS `bd_registro` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `bd_registro`;
...
CREATE TABLE `tareas` (
  ...
  `nomb_tarea` varchar(50) NOT NULL,
  `desc_tarea` varchar(300) NOT NULL,
